...
class Cosal_Sub_Module(nn.Module):
    ...
    def forward(self, feats, SISMs):
        ...
        main_pro = torch.gather(all_pro, dim=0, index=ind)[:32, :].view(32, C, 1, 1)
...
class CoRP(nn.Module):
    ...
    def forward(self, image_group, sal=None, is_training=True, gt=None):
        ...
        for i in range(iterations):
            ...
            _, cosal_map_1 = self.refine_1(conv1_2[:bs_group, ...], cosal_map_4, SISMs, feat_23)  # shape=[N, 1, 224, 224]
            maps = cosal_map_1
