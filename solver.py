...
import network_merge_4hw3

class Solver(object):
    def __init__(self):
        self.ICNet = network_merge_4hw3.ICNet().cuda()
    ...
    def train(self, roots, init_epoch, end_epoch, learning_rate, batch_size, weight_decay, ckpt_root, doc_path, num_thread, pin, vgg_path=None):
        ...
        if init_epoch == 0:
            ...
            self.ICNet.apply(network_merge_4hw3.weights_init)
        ...
        for epoch in range(init_epoch + 1, end_epoch):
            ...
            for data_batch in train_dataloader:
                ...
                if count%20 == 0:
                    print('epoch:',epoch, 'loss_sum:' ,loss.item(), 'loss_mean:', loss_m)
