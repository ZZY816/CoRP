...
def parse_args():
    ...
    parser.add_argument('--ckpt_root', type=str, default='./ckpt/ckpt_res_1_i/',
    ...
    parser.add_argument('--train_doc_path', type=str, default='./training_record/training_res_1_i.txt',
    ...
    parser.add_argument('--milestones', type=list, default=[55, 65], help='milestones for learning rate.')
    ...
    parser.add_argument('--backbone', type=str, default='resnet50',
                        help='The optional backbones are vgg16, vgg16bn, and resnet50.')
